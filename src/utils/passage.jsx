var textolder = `the museum hires musicians every evening
...
var text = [
  {
    passage: `There was once a woman who was very, very cherfull though she had litle to make her so; for she was old, and poor, and lonely. She lived in a little bit of a cottagge and earned a scant living by running errends for her neighbors, getting a bite here, a soup there, as reward for her services. So she mad a shift to get on, and always looked as happy and cheery as if she had not a want in the world.`,
    errorWords: ["cherfull", "litle", "cottagge", "errends", "mad"],
    correctWords: ["cheerful", "little", "cottage", "errands", "made"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },
  {
    passage: `Johnny Town-mouse was born in a cupboard. Timmy Willie was bortn in a garden. Timmy Willie was a little country mouse who went to town by mistake in a hamper. The gardener sent vegetabbles to town once a week by carrier; he packed them in a big hamper.
 ...
 The gardener left the hasmper by the garden gate, so tht the carrier could pick it up when he passed. Timmy Willie crept in thorough a hole in the wicker-work, and after eating some peas—Timmy Willie fell fast asleep.`,
    errorWords: ["bortn", "vegetabbles", "hasmper", "tht", "thorough"],
    correctWords: ["born", "vegetables", "hamper", "that", "through"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    ...
    errorWords: ["afrad", "nobdy", "mornings", "housee", "repaeting"],
    correctWords: ["afraid", "nobody", "morning", "house", "repeating"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `Without, the night was cold and wet, bat in the small parlor of Laburnum villa the blindes were drawn and the fires burned brightly. Fatther and son were at chess; the former, who possessed ideas about the game involving radical chances, putting his king into such sharp and unnecessary perils that it even provoked comment from the white-haired old lady knitting placidly by the fire. "Hark at the wind," said Mr. White, who, having seen a fatal mistak after it was too late, was amiably desirous of preventing his son from seeing it.
 `,
    errorWords: ["bat", "blindes", "fires", "Fatther", "mistak"],
    correctWords: ["but", "blinds", "fire", "Father", "mistake"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `When Martha Hale opend the storm-door and got a cut of the north wind, she ran back for her big woolen scarf. As she hurriedly wounds that round her head her eye made a scandalizzed sweep of her kitchen. It was no ordinary thing that called her away--it was probably further from ordinary than anything that had ever happened in Dickson County. But wat her eye took in was that her kitchen was in no shape for leaving: her bread all ready for mixing, half the flour sifted and hallf unsifted.`,
    errorWords: ["opend", "wounds", "scandalizzed", "wat", "hallf"],
    correctWords: ["opened", "would", "scandalized", "what", "half"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `The grl was one of those pretty and charming young creaturess who sometimes are born, as if by a slep of fate, into a family of clerks. She had no dowry, no expectations, no way of bing known, understood, loved, married by any rich and distinguished man; so she let herself be married to a little clerk of the Ministry of Public Instruction. She dressed plainly because she could not dress well, but she was unhappy as if she had really falle from a higher station; since with women there is neither caste nor rank, for beauty, grace and charm take the place of family and birth..`,
    errorWords: ["grl", "creaturess", "slep", "bing", "falle"],
    correctWords: ["girl", "creatures", "slip", "being", "fallen"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `It was on the first day of the New Yer that the announcemant was made, almost simultaneously fron three observatories, that the motion of the planet Neptune, the outermost of all the planets that wheele about the sun, had become very erratic. Ogilvy had already called attention to a suspected retardation in its velocity in December. Such a piece of news was scarcely calculated to interest a worldd the greater portion of whose inhabitants were unaware of the existence of the planet Neptune.`,
    errorWords: ["Yer", "announcemant", "fron", "wheele", "worldd"],
    correctWords: ["Year", "announcement", "from", "wheel", "world"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `All were crouding around M. Bermutier, the judge, who was giving his opinion about the Saint-Cloud mystery. For a moth this inexplecable crime had been the talk of Paris. Nobady could make head or tail of it. M. Bermutier, standing with his back to the fireplace, was talking, citing the evidence, discussing the various theories, but arriving at no conclusion. Some women had risen, in order to get nearer to him, and were stading with their eyes fastened on the clean-shaven face of the judge, who was saying such weighty things.`,
    errorWords: ["crouding", "moth", "inexplecable", "Nobady", "stading"],
    correctWords: ["crowding", "month", "inexplicable", "Nobody", "standing"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `One sanny afternoon in the autumn of the year 1861 a solder lay in a clump of laurel by the side of a road in western Virginia. He lay at full lenth upon his stomach, his feet resting upon the toes, his head upoon the left forearm. His extended right hand losely grasped his rifle. But for the somewhat methodical disposition of his limbs and a slight rhythmic movement of the cartridge-box at the back of his belt he might have been thought to be dead. He was asleep at his post of duty.`,
    errorWords: ["sanny", "solder", "lenth", "upoon", "losely"],
    correctWords: ["sunny", "soldier", "length", "upon", "losely"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `My auntt will be down presently, Mr. Nuttel," said a very self-possessed youn lady of fifteen; "in the meantime u must try and putt up with me."
 ...
 Adolph von Menzel, View from a Window in the Marienstrasse, 1865Framton Nuttel endeavored to say the correct something whch should duly flatter the niece of the moment without unduly discounting the aunt that was to come. Privately he doubted more than ever whether these formal visits on a succession of total strangers would do much towards helping the nerve cure which he was supposed to be undergoing.`,
    errorWords: ["auntt", "youn", "u", "putt", "whch"],
    correctWords: ["aunt", "young", "you", "put", "which"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `The fact tht Henry Armstrong was burried did not seem to him to prove that he was dead: he had alweys been a hard man to convince. That he realy was buried, the testimony of his senses compelled him to admit. His posture -- flat upon his back, with his hands crossed upon his stomac and tied with something that he easily broke without profitably altering the situation -- the strict confinement of his entire person, the black darkness and profound silence, made a body of evidence impossible to controvert and he accepted it without cavil.`,
    errorWords: ["tht", "burried", "alweys", "realy", "stomac"],
    correctWords: ["that", "buried", "always", "really", "stomach"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `TRUE!-NERVOUS--very, very dreadfully nervous I had been and am! But why will you say that I am mad? The disase had sharpened my senses--not destroyed--not dulled them. Above all was the sens of hearing acute. I heard all things in the heaven and in the earth. I heard many things in hell. How, then, aam I mad? Hearken! and obsarve how healthily--how calmly I can tell you the whole story. It is impossible to tell how farst the idea entered my brain; but once conceived, it haunted me day and night`,
    errorWords: ["disase", "sens", "aam", "obsarve", "farst"],
    correctWords: ["disease", "sense", "am", "observe", "first"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `This is the story of the grate war that Rikki-tikki-tavi fought single - handd through the bathroomms of the big bungalow in Segowlee cantonment. Darzee, the Tailorbird, helped him, and Chuchundra, the musk-rat, who neve comes out into the middle of the floor, but always creeps raund by the wall, gave him advice, but Rikki-tikki did the real fighting. He was a mongoose, rather like a little cat in his fur and his tail, but quite like a weasel in his head and his habits.`,
    errorWords: ["grate", "handd", "bathroomms", "neve", "raund"],
    correctWords: ["great", "hand", "bathrooms", "never", "round"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `It was a day in March. Never, never begin a story this way when you writte one. No opening coud posibly be worse. It is unemaginativ flat, dry and likely to consist of mere wind. But in this instance it is allowable. For the following paragraph, which should have inaugurated the narrative, is too wildly extravagant and preposterous to be flaunted in the face of the reader withaut preparation. Sarah was crying over her bill of fare. Think of a New York girl shedding tears on the menu card!`,
    errorWords: ["writte", "coud", "posibly", "unemaginativ", "withaut"],
    correctWords: ["write", "could", "possibly", "unimaginative", "without"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },

  {
    passage: `Two young peopl who had not long been married were walking up and down the platform of a little contry station. His arm was round her waist, her haed was almost on his shoulder, and both were happy.
 ...
 The moon peeped up form the drifting cloudlets and frowned, as it seemed, envying their happiness and regratting her tedious and utterly superfluous virginity. The still air was heavy with the fragrance of lilac and wild cherry. Somewhere in the distance beyond the line a corncrake was calling.`,
    errorWords: ["peopl", "contry", "haed", "form", "regratting"],
    correctWords: ["people", "country", "head", "from", "regretting"],
    errorWordsObj: { woman: "woman", "cheerfull,": "cherfull," }
  },
...
module.exports = { getPassage, getSuggestion };
